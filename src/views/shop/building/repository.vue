<template>
    <section>
        ...
        <el-table :data="RpList">
            ...
            <el-table-column label="操作" min-width="200">
                <template slot-scope="scope">
                    ...
                    <el-button size="small" @click="changeStatus(scope.$index, scope.row)">{{ scope.row.status ===1 ? '暂停运营' : '恢复运营' }}</el-button>
        ...
        <!-- 关联楼栋 -->
        <el-dialog title="关联楼栋" width="80%" custom-class="aRelationStatus" :visible.sync="SwitchLock.RelationStatus"  :close-on-click-modal="true">
            <div>
                <el-col>
                    <h2>已关联</h2>
                ...
                <el-col>
                    <h2>未关联</h2>
                    <el-table :data="RelationForm.noRelation">
