<template>
  <section>
    ...
    <el-table :data="messageOrders" highlight-current-row style="width: 100%;">
      <el-table-column prop="number" label="订单编号" align="center" width="140" sortable></el-table-column>
      <el-table-column prop="money" label="订单金额" align="center" width="100"></el-table-column>
      <el-table-column prop="building" label="订单楼栋" align="center" width="100"></el-table-column>
      <el-table-column prop="goods" label="商品件数" align="center" width="100"></el-table-column>
      ...
      <el-table-column prop="riderName" label="配送骑手姓名" align="center" width="120"></el-table-column>
      <el-table-column prop="buyerName" label="卖家昵称" align="center" width="120"></el-table-column>
    ...
    >
      <el-form :data="checkForm" id="table">
        ...
        <el-form :inline="true">
          <el-form-item label="商品件数" style="width:45%">{{checkForm.goods}}</el-form-item>
          <el-form-item label="买家地址">{{checkForm.buyerBuilding}}</el-form-item>
        </el-form>
        ...
        <el-form :inline="true">
          <el-form-item label="骑手姓名" style="width:45%">{{checkForm.riderName}}</el-form-item>
          <el-form-item label="骑手手机号">{{checkForm.riderPhone}}</el-form-item>
        </el-form>

        <el-form :inline="true">
          <el-form-item label="管理楼栋" style="width:45%">{{checkForm.building}}</el-form-item>
          <el-form-item label="工作状态">{{ handleRiderStatus(checkForm.status) }}</el-form-item>
        </el-form>

        <el-form>
          <el-form-item label="商品总数">{{checkForm.ordersNumber}}</el-form-item>
        </el-form>
      </el-form>
    </el-dialog>
  </section>
